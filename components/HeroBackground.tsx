  ...
  return (
    <>
      ...
      <div 
        ...
        style={{
          backgroundImage: `
            linear-gradient(rgba(124, 255, 196, 0.1) 1px, transparent 1px),
            linear-gradient(90deg, rgba(124, 255, 196, 0.1) 1px, transparent 1px)
          `,
      ...
      <div className="absolute top-1/2 right-1/4 w-64 h-64 bg-teal/3 rounded-full blur-3xl" />
