...
The maximum CPP retirement pension at age 65 is set by Service Canada and adjusted each January for the cost of living. Most people receive less than the maximum: in 2026 the average new beneficiary starting CPP at age 65 receives roughly **$1,365 per month**, while the maximum is higher. Your own amount depends on how much and how long you contributed — check your CPP Statement of Contributions and the current maximum on Canada.ca.
...
Both employees and employers contribute 5.95% of pensionable earnings up to the Year's Maximum Pensionable Earnings (YMPE), which is $74,600 for 2026. Self-employed individuals pay both portions, totaling 11.9%.

## Old Age Security (OAS) Updates for 2026

### OAS Payment Amounts

For January to March 2026, the maximum OAS pension is **$740.09 per month** for individuals aged 65 to 74, and **$814.10 per month** for those 75 and older. OAS amounts are adjusted quarterly based on the Consumer Price Index (CPI).

### OAS Clawback Threshold

The OAS clawback (recovery tax) applies once your net income exceeds **$93,454** — the threshold for the 2025 income year, which affects OAS payments from July 2026 to June 2027. For every dollar of income above this threshold, OAS benefits are reduced by $0.15, with complete elimination at approximately $154,708 of income for those aged 65 to 74. The threshold is indexed to inflation each year.
